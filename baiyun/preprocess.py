...
#			timestamp = int(time.mktime(time.strptime(line_list[2], "%Y-%m-%d-%H-%M-%S")))
...
#	generate_prediction_csv("./processeddata/flight/flight_info.csv", "./processeddata/prediction/date.csv")
